    ...
    const initialDelegates = [
        {
            id: 1,
            name: 'Delegate 1',
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores possimus, nobis deleniti numquam, unde placeat quisquam similique perspiciatis in fugiat sapiente aspernatur maxime sunt modi praesentium ex repellendus iure voluptates.',
            image: arbImage,
        },
        {
            id: 2,
            name: 'Delegate 2',
            description: 'consectetur adipisicing elit. Maiores possimus, nobis deleniti numquam, unde placeat quisquam similique perspiciatis in fugiat sapiente aspernatur maxime sunt modi praesentium ex repellendus iure voluptates.',
            image: arbImage,
        },
        {
            id: 3,
            name: 'Delegate 3',
            description: 'sit amet consectetur adipisicing elit. Maiores possimus, nobis deleniti numquam, unde placeat quisquam similique perspiciatis in fugiat sapiente aspernatur maxime sunt modi praesentium ex repellendus iure voluptates.', image: arbImage,
        },
    ];
            ...
            <div className="m-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {initialDelegates.map((delegate) => (
                    ...
                    >
                        ...
                        onClick={() => { router.push(`/delegates/${delegate.id}`) }}
                        >
                            ...
                            <div className="ml-2">
                                <p className="text-lg font-semibold mb-2 text-black">{delegate.name}</p>
                            </div>
                        </div>
                        <p className="text-sm text-muted-foreground mb-4 line-clamp-2 text-gray-600">{delegate.description}</p>
                        {/* </Link> */}
                        <button
